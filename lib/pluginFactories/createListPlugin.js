...
function createSlatePlugins(def, customizers) {
    ...
    return [
        (0, createSimpleHtmlBlockPlugin_1.default)({
            type: def.type,
            icon: def.icon,
            label: def.label,
            ...
            customAdd: function (editor) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require('./utils/listUtils')); })];
                        case 1:
                            ...
                            return [3 /*break*/, 4];
                        case 2: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require('slate')); })];
                        case 3:
        ...
        (0, createListItemPlugin_1.default)(listItem)(customizers.customizeListItem),
    ];
}
...
function createListPlugin(defRaw) {
    var _a;
    var def = __assign(__assign({}, defRaw), { type: constants_1.LISTS_TYPE_PREFIX + defRaw.type, listItem: (_a = defRaw.listItem) !== null && _a !== void 0 ? _a : {
            tagName: 'li',
            type: constants_1.LI,
        } });
